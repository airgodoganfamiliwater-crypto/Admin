...
<div class="navbar-bottom gempa-mode">
  ...
  <div class="nav-item" data-index="0" data-view="index">
  ...
  <div class="nav-item" data-index="1" data-view="analis">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
  ...
  <div class="nav-item" data-index="2" data-view="dashboard">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
  ...
  <div class="nav-item" data-index="3" data-view="statement">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
